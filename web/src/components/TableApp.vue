        ...
        <div class="lg:max-w-full m-0 overflow-x-auto">
          <table class="border-separate border-spacing-y-3">
            <thead class="uppercase bg-[#ffffff] text-[#A1A8B8] text-left text-xs border">
              <tr>
                <th class="w-1/6 min-w-[160px] font-semibold py-3 lg:py-4 border-l border-transparent">
                  nota fiscal
                </th>
                <th class="w-1/6 min-w-[160px] font-semibold py-3 lg:py-4 border-l border-transparent">
                  sacado
            ...
            <tbody class="bg-[#fefefe]">
              <tr class="h-12" v-for="order in orders" :key="order.id">
                ...
                <td class="uppercase border-b border-t border-[#DFE2EB] px-2 text-[#A1A8B8] text-sm">
                  {{ order.buyers.name }}
                </td>
                <td class="uppercase border-b border-t border-[#DFE2EB] px-2 text-[#A1A8B8] text-sm">
                ...
                <td class="uppercase border-b border-t border-[#DFE2EB] px-2 text-[#00AD8C] text-sm">
                  {{ order.value }}
                </td>
                <td class="uppercase border-b border-t border-[#DFE2EB] px-2 text-[#00AD8C] text-sm">
                ...
                <td class="border-b border-t border-r rounded border-[#DFE2EB] px-2">
                  <button type="button" @click="showModal(order.providers.id)"
                    class="w-[165px] h-[32px] rounded-[24px] border-[1px] text-xs border-[#CAD3FF] text-[#727D94]">
                    Dados do cedente
                  </button>
                </td>
              </tr>
